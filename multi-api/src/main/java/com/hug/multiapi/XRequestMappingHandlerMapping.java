...
public class XRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
    ...
    private RequestCondition<ApiRequestCondition> createCondition(ApiVersion apiVersion) {
        return apiVersion == null ? null : new ApiRequestCondition(apiVersion.value(), apiVersion.missRule());
    }
}